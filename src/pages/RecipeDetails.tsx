      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="overflow-hidden shadow-lg border-2">
            {/* Recipe Image Placeholder (no AI image) */}
            <div className="w-full h-80 flex items-center justify-center bg-gray-100 dark:bg-gray-700">
              <div className="text-center">
                <ChefHat className="w-16 h-16 mx-auto text-gray-400 mb-4" />
                <span className="text-gray-500 dark:text-gray-400 text-lg">Recipe Image</span>
              </div>
            </div>
